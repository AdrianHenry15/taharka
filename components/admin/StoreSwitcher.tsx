...
interface AdminStoreSwitcherProps extends PopoverTriggerProps {
    className: string;
    items: Record<string, any>[];
}

export default function AdminStoreSwitcher({ className, items = [] }: AdminStoreSwitcherProps) {
    const storeModal = React.useContext<GlobalStateStore>(GlobalStateContext).Modal;
